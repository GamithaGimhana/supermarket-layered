...
//            lblCustomerId.setText(nextCustomerID);
    ...
    private void refreshPage() throws SQLException, ClassNotFoundException {
        ...
        String nextCustomerID = customerBOImpl.getNextId();
        lblCustomerId.setText(nextCustomerID);
    ...
    private void refreshTable() throws SQLException, ClassNotFoundException {
        ArrayList<CustomerDTO> customers = customerBOImpl.getAll();
...
//        Validate each field using regex patterns
        ...
        if (isValidName && isValidNic && isValidEmail && isValidPhone) {
            CustomerDTO customer = new CustomerDTO(id, name, nic, email, phone);

            boolean isSaved = customerBOImpl.save(customer);
    ...
    void btnDeleteOnAction(ActionEvent event) throws SQLException, ClassNotFoundException {
        ...
        if (buttonType.get() == ButtonType.YES) {
            ...
            boolean isDeleted = customerBOImpl.delete(customerId);
